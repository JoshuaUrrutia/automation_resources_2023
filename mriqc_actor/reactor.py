...
UPLOAD_DIR = '/work2/05369/urrutia/frontera/bids'
SUBJECT_ID = '01'
...
def main() -> None:
    ...
    for path in unsubmitted:
        ...
        job['parameterSet']['envVariables'][0]['value'] = '/'+path
        # set the subject id
        job['parameterSet']['envVariables'][1]['value'] = SUBJECT_ID
        # set the archive location for the job
        job['archiveSystemDir'] = upload_dir.replace('bids','mriqc')
        # submits the job
